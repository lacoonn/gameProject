...
def initGame():
    ...
    global player_group, enemy_group

    pygame.init()
    gamepad = pygame.display.set_mode((WIDTH, HEIGHT), DOUBLEBUF)
    clock = pygame.time.Clock()

    player1 = swm.swordsman('img_src/swordsman.png', (100, 300))
    player2 = swm.swordsman('img_src/swordsman.png', (150, 500))
    players = [player1, player2]
    player_group = pygame.sprite.RenderPlain(*players)

    enemy1 = swm.swordsman('img_src/swordsman.png', (600, 200))
    enemy2 = swm.swordsman('img_src/swordsman.png', (1100, 400))
...
def runGame():
    ...
    while True:
        ...
        while isMenu is False:
            ...
            gamepad.fill(WHITE)
            # 유닛 출력
            player_group.draw(gamepad)
            enemy_group.draw(gamepad)
            # 설정
            pygame.display.update()
            clock.tick(60)
